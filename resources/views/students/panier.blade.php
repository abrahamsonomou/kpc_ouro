                ...
                <a href="#" class="relative d-block rounded-8 px-10 py-10 border-light">
                  <div class="row x-gap-20 y-gap-20 items-center">
                    <div class="col-md-auto">
                      <div class="shrink-0">
                        <img class="w-1/1" src="{{ asset('assets/img/dashboard/bookmarks/1.png') }}" alt="image">
                      </div>
                    </div>
              ...
              <div class="col-xl-6">
                  <a href="#" class="relative d-block rounded-8 px-10 py-10 border-light">
                    <div class="row x-gap-20 y-gap-20 items-center">
                      <div class="col-md-auto">
                        <div class="shrink-0">
                          <img class="w-1/1" src="{{ asset('assets/img/dashboard/bookmarks/2.png') }}" alt="image">
                        </div>
                      </div>
                      ...
                      <div class="col-md">
                        ...
                        <div class="d-flex y-gap-10 justify-between items-center flex-wrap border-top-light pt-10 mt-10">
                          <div class="d-flex items-center">
                            <img src="{{ asset('assets/img/general/avatar-2.png') }}" alt="image">
                            <div class="text-14 lh-1 ml-10">Ali Tufan</div>
                          </div>
