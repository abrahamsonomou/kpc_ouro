                          ...
                          <div class="row justify-between x-gap-40 pb-20">
                            <div class="col">
                              <div class="row x-gap-10 y-gap-10">
                                <div class="col-auto">
                                  <img src="{{ asset('assets/img/menus/cart/1.png') }}" alt="image">
                                </div>
          ...
          <div class="dashboard__sidebar scroll-bar-1">
            ...
            <div class="sidebar -dashboard">
              ...
              <div class="sidebar__item @yield('isActive1')">
                <a href="{{ route('instructors.dashboard') }}" class="d-flex items-center text-17 lh-1 fw-500 ">
              ...
              <div class="sidebar__item @yield('isActive2')">
                <a href="{{ route('instructors.my_cours') }}" class="d-flex items-center text-17 lh-1 fw-500 -dark-text-white">
              ...
              <div class="sidebar__item @yield('isActive4')">
                <a href="{{ route('instructors.create_cours') }}" class="d-flex items-center text-17 lh-1 fw-500 ">
              ...
              <div class="sidebar__item @yield('isActive3')">
                <a href="{{ route('instructors.my_articles') }}" class="d-flex items-center text-17 lh-1 fw-500 ">
              ...
              <div class="sidebar__item @yield('isActive7')">
                <a href="{{ route('instructors.create_articles') }}" class="d-flex items-center text-17 lh-1 fw-500 ">
                  <i class="text-20 icon-list mr-15"></i>
                  Create Articles
                </a>
              </div>
