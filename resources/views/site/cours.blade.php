            ...
            <div class="row y-gap-30">
                ...
                <div class="col-xl-3 col-lg-4 col-md-6">
                    ...
                    <a href="courses-single-1.html" class="coursesCard -type-1 ">
                        ...
                        <div class="h-100 pt-15">
                            ...
                            <div class="text-17 lh-15 fw-500 text-dark-1 mt-10">Learn Figma - UI/UX Design Essential
                                Training</div>
                ...
                <div class="col-xl-3 col-lg-4 col-md-6">
                    ...
                    <a href="courses-single-1.html" class="coursesCard -type-1 ">
                        ...
                        <div class="h-100 pt-15">
                            ...
                            <div class="text-17 lh-15 fw-500 text-dark-1 mt-10">Complete Python Bootcamp From Zero to Hero
                                in Python</div>
                ...
                <div class="col-xl-3 col-lg-4 col-md-6">
                    ...
                    <a href="courses-single-1.html" class="coursesCard -type-1 ">
                        ...
                        <div class="h-100 pt-15">
                            ...
                            <div class="text-17 lh-15 fw-500 text-dark-1 mt-10">Angular - The Complete Guide (2022 Edition)
                            </div>
                ...
                <div class="col-xl-3 col-lg-4 col-md-6">
                    ...
                    <a href="courses-single-1.html" class="coursesCard -type-1 ">
                        ...
                        <div class="h-100 pt-15">
                            ...
                            <div class="text-17 lh-15 fw-500 text-dark-1 mt-10">The Ultimate Drawing Course Beginner to
                                Advanced</div>
                ...
                <div class="col-xl-3 col-lg-4 col-md-6">
                    ...
                    <a href="courses-single-1.html" class="coursesCard -type-1 ">
                        ...
                        <div class="h-100 pt-15">
                            ...
                            <div class="text-17 lh-15 fw-500 text-dark-1 mt-10">Photography Masterclass: A Complete Guide
                                to Photography</div>
                ...
                <div class="col-xl-3 col-lg-4 col-md-6">
                    ...
                    <a href="courses-single-1.html" class="coursesCard -type-1 ">
                        ...
                        <div class="h-100 pt-15">
                            ...
                            <div class="text-17 lh-15 fw-500 text-dark-1 mt-10">Instagram Marketing 2021: Complete Guide To
                                Instagram Growth</div>
                ...
                <div class="col-xl-3 col-lg-4 col-md-6">
                    ...
                    <a href="courses-single-1.html" class="coursesCard -type-1 ">
                        ...
                        <div class="h-100 pt-15">
                            ...
                            <div class="text-17 lh-15 fw-500 text-dark-1 mt-10">The Complete Financial Analyst Training
                ...
                <div class="col-xl-3 col-lg-4 col-md-6">
                    ...
                    <a href="courses-single-1.html" class="coursesCard -type-1 ">
                        <div class="relative">
                            <div class="coursesCard__image overflow-hidden rounded-8">
                                <img class="w-1/1" src="assets/img/coursesCards/9.png" alt="image">
                                <div class="coursesCard__image_overlay rounded-8"></div>
                            </div>
                            <div class="d-flex justify-between py-10 px-10 absolute-full-center z-3">
                ...
                <div class="col-xl-3 col-lg-4 col-md-6">
                    ...
                    <a href="courses-single-1.html" class="coursesCard -type-1 ">
                        <div class="relative">
                            <div class="coursesCard__image overflow-hidden rounded-8">
                                <img class="w-1/1" src="assets/img/coursesCards/10.png" alt="image">
                                <div class="coursesCard__image_overlay rounded-8"></div>
                            </div>
                            <div class="d-flex justify-between py-10 px-10 absolute-full-center z-3">
                ...
                <div class="col-xl-3 col-lg-4 col-md-6">
                    ...
                    <a href="courses-single-1.html" class="coursesCard -type-1 ">
                        <div class="relative">
                            <div class="coursesCard__image overflow-hidden rounded-8">
                                <img class="w-1/1" src="assets/img/coursesCards/11.png" alt="image">
                                <div class="coursesCard__image_overlay rounded-8"></div>
                            </div>
                            <div class="d-flex justify-between py-10 px-10 absolute-full-center z-3">
                ...
                <div class="col-xl-3 col-lg-4 col-md-6">
                    ...
                    <a href="courses-single-1.html" class="coursesCard -type-1 ">
                        <div class="relative">
                            <div class="coursesCard__image overflow-hidden rounded-8">
                                <img class="w-1/1" src="assets/img/coursesCards/12.png" alt="image">
                                <div class="coursesCard__image_overlay rounded-8"></div>
                            </div>
                            <div class="d-flex justify-between py-10 px-10 absolute-full-center z-3">
